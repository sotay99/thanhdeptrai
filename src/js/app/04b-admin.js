  ...
  const MODULE_ADMIN = [
    ...
    { ma: 'khoa-hoc-pc', ten: 'Khoá học Lightroom máy tính', bieuTuong: '🖥️' }
  ];
  ...
  const O_LIEN_HE = [
    ...
    { truong: 'telegram',    ten: 'Địa chỉ Telegram của shop', kieu: 'chu',
      goi: '@tenshop hoặc https://t.me/tenshop',
      ghiChu: 'Dán cả đường dẫn t.me hoặc chỉ tên @ đều được.' },
    { truong: 'whatsapp',    ten: 'Số WhatsApp của shop',      kieu: 'so',
      goi: 'Để trống nếu chưa có' },
    { truong: 'emailShop',   ten: 'Địa chỉ Email của shop',    kieu: 'chu',
      goi: 'shop@vidu.com',
      ghiChu: 'Đây là email khách nhìn thấy để liên hệ, không phải email nhận thông báo đơn hàng.' },
  ...
  function veModuleAdmin(ma){
    ...
    if (ma === 'khoa-hoc-pc') return veAdminKhoaHocMayTinh();
